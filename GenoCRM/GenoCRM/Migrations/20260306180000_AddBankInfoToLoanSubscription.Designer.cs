...
namespace GenoCRM.Migrations
{
    ...
    [Migration("20260306180000_AddBankInfoToLoanSubscription")]
    partial class AddBankInfoToLoanSubscription
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GenoCRM.Models.Domain.LoanOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("LoanProjectId")
                        .HasColumnType("integer");

                    b.Property<decimal?>("MaxSubscriptionAmount")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("MinSubscriptionAmount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("GenoCRM.Models.Domain.LoanPaymentPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("LoanSubscriptionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LoanSubscriptionId")
                        .IsUnique();

                    b.ToTable("LoanPaymentPlans", (string)null);
                });

            modelBuilder.Entity("GenoCRM.Models.Domain.LoanPaymentPlanEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("LoanPaymentPlanId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LoanPaymentPlanId");

                    b.HasIndex("Status");

                    b.ToTable("LoanPaymentPlanEntries", (string)null);
                });

            modelBuilder.Entity("GenoCRM.Models.Domain.LoanProject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("LoanProjects", (string)null);
                });

            modelBuilder.Entity("GenoCRM.Models.Domain.LoanSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("PaidInDate")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.ToTable("LoanSubscriptions", (string)null);
                });
            ...
            modelBuilder.Entity("GenoCRM.Models.Domain.LoanOffer", b =>
                {
                    b.HasOne("GenoCRM.Models.Domain.LoanProject", "LoanProject")
                        .WithMany("LoanOffers")
                        .HasForeignKey("LoanProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LoanProject");
                });

            modelBuilder.Entity("GenoCRM.Models.Domain.LoanPaymentPlan", b =>
                {
                    b.HasOne("GenoCRM.Models.Domain.LoanSubscription", "LoanSubscription")
                        .WithOne("PaymentPlan")
                        .HasForeignKey("GenoCRM.Models.Domain.LoanPaymentPlan", "LoanSubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LoanSubscription");
                });

            modelBuilder.Entity("GenoCRM.Models.Domain.LoanPaymentPlanEntry", b =>
                {
                    b.HasOne("GenoCRM.Models.Domain.LoanPaymentPlan", "LoanPaymentPlan")
                        .WithMany("Entries")
                        .HasForeignKey("LoanPaymentPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LoanPaymentPlan");
                });

            modelBuilder.Entity("GenoCRM.Models.Domain.LoanSubscription", b =>
                {
                    b.HasOne("GenoCRM.Models.Domain.LoanOffer", "LoanOffer")
            ...
            modelBuilder.Entity("GenoCRM.Models.Domain.Payment", b =>
                {
                    b.HasOne("GenoCRM.Models.Domain.LoanSubscription", "LoanSubscription")
                        .WithMany("Payments")
                        .HasForeignKey("LoanSubscriptionId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("GenoCRM.Models.Domain.Member", b =>
                {
                    ...
                    b.Navigation("LoanSubscriptions");
